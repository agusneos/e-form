...
{    
	...
	if (!empty($filterRules)){
        ...
        $this->db->select('a.*, c.departemen_nama as "c.departemen_nama", b.departemen_nama as "b.departemen_nama", 
                            d.karyawan_nama as "d.karyawan_nama", e.name as "e.name", f.name as "f.name"', NULL);
        ...
        $this->db->join(self::$table4.' e', 'a.fizin_disetujui = e.id', 'left');
        $this->db->join(self::$table4.' f', 'a.fizin_diketahui = f.id', 'left');
...
/* Location: ./application/models/approval/izin.php */