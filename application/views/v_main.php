...
<head>   
    <meta charset="UTF-8">
    <title>Aplikasi Digital Form</title>
    <link rel="icon" type="image/png" href="<?=base_url('assets/easyui/themes/icons/form.png')?>">
...
<body>    
    ...
    <div class="easyui-layout" fit="true" style="width:700px;height:350px;">
        ...
        <div data-options="region:'south',split:false" style="height:100px;">
            <h1 align="center">Aplikasi Digital Form Ver. 1.0</h1>
