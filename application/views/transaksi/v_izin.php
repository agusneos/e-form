...
<table id="grid-transaksi_izin"
    data-options="pageSize:50, multiSort:true, remoteSort:false, rownumbers:true, singleSelect:true, 
                fit:true, fitColumns:true, toolbar:toolbar_transaksi_izin">
    <thead>
        <tr>
            <th data-options="field:'ck',checkbox:true" ></th>
            <th data-options="field:'fizin_id'"         width="70" halign="center" align="center" sortable="true">ID</th>
            <th data-options="field:'fizin_tanggal'"    width="100" align="center" sortable="true">Tanggal</th>
            <th data-options="field:'d.karyawan_nama'"        width="70" halign="center" align="center" sortable="true">Nama Karyawan</th>
            ...
            <th data-options="field:'fizin_jenis'"      width="200" halign="center" align="left" sortable="true">Jenis Izin</th>
            <th data-options="field:'fizin_dari'"       width="100" halign="center" align="center" sortable="true">Dari</th>
            ...
            <th data-options="field:'fizin_disetujui'"  width="150" halign="center" align="center" sortable="true">Disetujui</th>
            <th data-options="field:'fizin_diketahui'"  width="150" halign="center" align="center" sortable="true">Diketahui</th>
        </tr>
    </thead>
</table>
