...
<table id="grid-transaksi_izin"
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'fizin_keperluan'"      width="150" halign="center" align="left"   sortable="true" >Keperluan</th>
            <th data-options="field:'fizin_keterangan'"     width="150" halign="center" align="left"   sortable="true" >Keterangan</th>
