...
<table id="grid-transaksi_pjken"
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'fpjken_keperluan'"     width="150" halign="center" align="left"   sortable="true" >Keperluan</th>
            <th data-options="field:'fpjken_keterangan'"    width="150" halign="center" align="left"   sortable="true" >Keterangan</th>
